...
export default class extends Controller {
    ...
    async fetchDatabase() {
        ...
        return fetch(`reservation/hebergements?start=${this.reservation.durée.début.str}&end=${this.reservation.durée.fin.str}&adult=${this.reservation.nombre.adultes}&child=${this.reservation.nombre.enfants}`)
            .then(response => response.json())
            .then(displayHebergements => {
                data.displayHebergements = displayHebergements
        ...
        switch (number) {
            case 0:
                ...
                if (this.reservation.durée.début.date instanceof Date
                    ...
                    // Recupere les données par rapport au séjour
                    console.log("AVANT")
                    this.database = await this.fetchDatabase()
                    console.log("APRES")
                ...
                // ! ajoute les cartes hébérgement
                this.addDisplayHebergements()
    ...
    */
    ...
    addDisplayHebergements() {
        let container = document.querySelector('#displayHebergements')

        container.innerHTML = "caca";
        console.log(this.database.displayHebergements)
